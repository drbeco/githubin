...
/***************************************************************************
 *   exN.pl                                   Version 20170509.004550      *
 *                                                                         *
 *   Brief description                                                     *
 ...
 * @ingroup GroupUnique
 * @brief help is det
 * @details Shows a help message on how to use exN
 * @return TRUE always.
 */
help :-
    writeln('exN - Brief description'),
    writeln('Usage:'),
    writeln('$swipl -s exN'),
 ...
 */
copyright :-
    writeln('exN - Version 20170509.004550'),
